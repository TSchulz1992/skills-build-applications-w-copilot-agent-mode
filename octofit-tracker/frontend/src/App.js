    ...
    <Router>
      <div className="container">
        ...
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4"><h2 className="card-title">Willkommen zum Octofit Tracker!</h2><p className="card-text">Wähle eine Kategorie im Menü.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
